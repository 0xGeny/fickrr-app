      ...
      <div class="container d-flex flex-wrap flex-sm-nowrap justify-content-center justify-content-sm-between align-items-center pt-2">
        <div class="media media-ie-fix align-items-center pb-3">
          ...
          <div class="media-body pl-3">
            <h3 class="text-light font-size-lg mb-0"><?php echo e($user['user']->username); ?> <?php if($addition_settings->subscription_mode == 1): ?> <?php if($user['user']->verified == 1): ?> <span class="badges-success"><i class="dwg-check-circle danger"></i> <?php echo e(Helper::translation(5202,$translate)); ?></span> <?php endif; ?> <?php endif; ?></h3>
