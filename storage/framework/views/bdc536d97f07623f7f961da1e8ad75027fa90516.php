        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page">Subscription</li>
            </ol>
          </nav>
        </div>
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0 text-white">Subscription</h1>
        </div>
      </div>
      </div>
    </section>
<div class="container py-5 mt-md-2 mb-2">
      <div class="row">
        <div class="col-lg-12" data-aos="fade-up" data-aos-delay="200" align="center">
          <h4>Your subscription has been expired. Please renewal your <a href="<?php echo e(URL::to('/subscription')); ?>">subscription</a></h4><br/>
         </div>
      </div>
    </div><?php /**PATH D:\xampp\htdocs\fickrr\resources\views/expired.blade.php ENDPATH**/ ?>