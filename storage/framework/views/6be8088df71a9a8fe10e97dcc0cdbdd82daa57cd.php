...
<div class="container pb-5 mb-2 mb-md-3">
      <div class="row">
        ...
        <section class="col-lg-8">
          ...
          <h4 class="h4 py-2 text-center text-sm-left"  style="display:none;"><?php echo e(Auth::user()->user_subscr_type); ?> <?php echo e(Helper::translation(6156,$translate)); ?></h4>
          ...
          <form action="<?php echo e(route('profile-settings')); ?>" class="needs-validation" id="profile_form" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <?php if($count_mode == 1): ?>
              <div class="col-sm-12 mt-4 mb-1">
              <h4 class="mt-4"  style="display:none;"><?php echo e(Helper::translation(5604,$translate)); ?></h4>
              </div>
              <div class="col-sm-6" style="display:none;">
                <div class="form-group">
              ...
              <div class="col-sm-12 mt-4 mb-1">
              <h4 class="mt-4" style="display:none;"><?php echo e(Helper::translation(5733,$translate)); ?></h4>
              </div>
              <div class="col-sm-6" style="display:none;">
                <div class="form-group">
    ...
    </div><?php /**PATH /var/www/html/resources/views/profile.blade.php ENDPATH**/ ?>