...
<section class="container mb-lg-1" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="d-flex flex-wrap justify-content-between align-items-center pt-1 border-bottom pb-4 mb-4">
        <h2 class="h3 mb-0 pt-3 mr-2" data-aos="fade-down" data-aos-delay="100"><?php echo e(Helper::translation(3027,$translate)); ?></h2>
...
<section class="container mb-lg-1 flash-sale" data-aos="fade-up" data-aos-delay="200" style="display:none;">
    ...
    <?php endif; ?>
    <?php if($allsettings->site_features_display == 'for hide'): ?>  // $allsettings->site_features_display == 1
    <section class="bg-size-cover bg-position-center pt-5 pb-4 pb-lg-5 feature-panel" style="background-image: url('<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($allsettings->site_banner); ?>');" style="display:none;">
