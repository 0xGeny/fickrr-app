            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(Helper::translation(5247,$translate)); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" <?php if($edit['page']->page_status == 1): ?> selected="selected" <?php endif; ?>><?php echo e(Helper::translation(2874,$translate)); ?></option>
                                                <option value="0" <?php if($edit['page']->page_status == 0): ?> selected="selected" <?php endif; ?>><?php echo e(Helper::translation(2875,$translate)); ?></option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" <?php if($edit['page']->main_menu == 1): ?> selected="selected" <?php endif; ?>><?php echo e(Helper::translation(2970,$translate)); ?></option>
                                                <option value="0" <?php if($edit['page']->main_menu == 0): ?> selected="selected" <?php endif; ?>><?php echo e(Helper::translation(2971,$translate)); ?></option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" <?php if($edit['page']->footer_menu == 1): ?> selected="selected" <?php endif; ?>><?php echo e(Helper::translation(2970,$translate)); ?></option>
                                                <option value="0" <?php if($edit['page']->footer_menu == 0): ?> selected="selected" <?php endif; ?>><?php echo e(Helper::translation(2971,$translate)); ?></option>
                                                </select>
...
<?php /**PATH /var/www/html/resources/views/admin/edit-page.blade.php ENDPATH**/ ?>