...
<footer class="bg-dark pt-5">
    ...
    <?php endif; ?>
    <a class="btn-scroll-top" href="#top" data-scroll><span class="btn-scroll-top-tooltip text-muted font-size-sm mr-2"><?php echo e(Helper::translation(5976,$translate)); ?></span><i class="btn-scroll-top-icon dwg-arrow-up"></i></a><?php /**PATH /var/www/html/fickrr/resources/views/footer.blade.php ENDPATH**/ ?>