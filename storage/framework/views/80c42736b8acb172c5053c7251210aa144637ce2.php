            ...
            <div class="cz-sidebar-static h-100 ml-auto border-left">
              ...
              <p class="mt-2 mb-3"><a href="javascript:void(0)" data-toggle="modal" data-target="#myModal" class="font-size-xs"><?php echo e($page['view']->page_title); ?></a></p>
                ...
                <div class="media-body pl-2 item-details">
                    ...
                    <div class="mb-3"><?php if($addition_settings->subscription_mode == 1): ?> <?php if($item['item']->verified == 1): ?> <span class="badges-success"><i class="dwg-check-circle danger"></i> <?php echo e(Helper::translation(5202,$translate)); ?></span> <?php endif; ?> <?php endif; ?></div>
                    <ul>
